...
public class MarineUnitAgent extends UnitAgent {
	...
	public MarineUnitAgent(GenericMaster master, Unit unit, Com com, Bot bot, Shared_LambdaQE shared) {
	...
	public void onUnitDestroy(Unit u) {
		if (this.unit.getID() == u.getID()) {
			addEvent(factory.newAbstractEvent(AEFDestruirUnidad.CODE_DEAD));
		} else {
			if (this.map.containsKey(u.getID())) {
